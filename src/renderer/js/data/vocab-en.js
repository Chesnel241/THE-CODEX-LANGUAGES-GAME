...
(function () {
  ...
  Codex.VOCAB["en-UK"] = { themes: [
    ...
    T("health", { fr: "Santé", en: "Health" }, [
      ["appointment", "rendez-vous", "arranged time to see someone"],
      ["GP", "médecin traitant", "general practitioner, family doctor"],
      ["surgery", "cabinet médical", "doctor's office (UK)"],
      ["waiting room", "salle d'attente", "room where patients wait"],
      ["cough", "toux", "sound from the throat when ill"],
      ["sore throat", "mal de gorge", "painful throat"],
      ["fever", "fièvre", "high body temperature"],
      ["dizzy", "pris de vertige", "feeling that things are spinning"],
      ["bruise", "bleu / hématome", "dark mark on skin after a knock"],
      ["sprain", "entorse", "twisted joint injury"],
      ["jab", "piqûre / vaccin (fam.)", "injection (informal, UK)"],
      ["sick leave", "arrêt maladie", "time off work when ill"],
    ]),
    T("home", { fr: "À la maison", en: "At home" }, [
      ["kettle", "bouilloire", "device that boils water"],
      ["cooker", "cuisinière", "appliance you cook on (UK)"],
      ["tap", "robinet", "where water comes out (US: faucet)"],
      ["sink", "évier", "basin for washing up"],
      ["fridge", "frigo", "refrigerator"],
      ["washing machine", "lave-linge", "machine that washes clothes"],
      ["duvet", "couette", "thick bed cover"],
      ["pillow", "oreiller", "soft head support in bed"],
      ["curtains", "rideaux", "fabric covering windows"],
      ["drawer", "tiroir", "sliding storage box in furniture"],
      ["broom", "balai", "brush for sweeping floors"],
      ["letterbox", "boîte aux lettres", "slot or box for mail (UK)"],
    ]),
  ] };
})();
